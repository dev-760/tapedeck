...
export default function DeckCalibrationHardwareSettings() {
    ...
    <SafeAreaView style={s.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
          ...
          <>
            ...
            <View style={s.card}>
              <View style={{ flexDirection: 'row', gap: 6, alignItems: 'center', marginBottom: 12 }}>
                <MaterialIcons name="settings-input-component" size={18} color={COLORS.secondary} />
        ...
        {tab === 'library' && (
          <View style={s.card}>
            <View style={{ flexDirection: 'row', gap: 6, alignItems: 'center', marginBottom: 12 }}>
              <MaterialIcons name="folder-special" size={18} color={COLORS.secondary} />
            ...
            <View style={[s.toggleRow, { marginTop: 12 }]}>
              ...
              <TouchableOpacity style={s.scanBtn}><MaterialIcons name="sync" size={16} color={COLORS.onPrimary} /><Text style={s.scanBtnTxt}>SCAN REELS</Text></TouchableOpacity>
            </View>
          </View>
        )}
        ...
        {tab === 'chassis' && (
          <View style={s.card}>
            <View style={{ flexDirection: 'row', gap: 6, alignItems: 'center', marginBottom: 12 }}>
              <MaterialIcons name="display-settings" size={18} color={COLORS.secondary} />
        ...
        {tab === 'maintenance' && (
          <View style={s.card}>
            <View style={{ flexDirection: 'row', gap: 6, alignItems: 'center', marginBottom: 12 }}>
              <MaterialIcons name="build-circle" size={18} color={COLORS.secondary} />
            ...
            <View style={s.subBox}>
              ...
              <TouchableOpacity style={s.demagBtn}><Text style={s.demagBtnTxt}>TRIGGER 400Hz DEMAG PULSE</Text></TouchableOpacity>
            </View>
          </View>
        )}
      </ScrollView>
      ...
      {/* Persistent Deck Bar */}
      <View style={s.dock}>
        <View style={s.dockHub}>
          <MaterialIcons name="album" size={22} color={COLORS.secondary} />
        </View>
        <View style={{ flex: 1 }}>
          <Text style={s.dockSub}>SIDE A // TRACK 03</Text>
          <Text style={s.dockTitle}>TAEKO ONUKI - 4:00A.M.</Text>
        </View>
        <TouchableOpacity style={s.dockBtn}><MaterialIcons name="fast-rewind" size={18} color={COLORS.onSurface} /></TouchableOpacity>
        <TouchableOpacity style={[s.dockBtn, { backgroundColor: COLORS.secondary }]} onPress={() => setIsPlaying(!isPlaying)}>
...
const s = StyleSheet.create({
  ...
  dock: { backgroundColor: COLORS.surfaceContainerLowest, padding: 8, flexDirection: 'row', alignItems: 'center', gap: 8 },
  dockHub: { width: 40, height: 40, borderRadius: 4, backgroundColor: COLORS.primaryContainer, alignItems: 'center', justifyContent: 'center' },
  dockSub: { fontFamily: FONTS.displayBold, fontSize: 9, color: COLORS.secondary, textTransform: 'uppercase', letterSpacing: 1 },
  dockTitle: { fontFamily: FONTS.display, fontSize: 13, color: COLORS.onSurface },
  dockBtn: { width: 36, height: 36, borderRadius: 4, backgroundColor: COLORS.surfaceContainer, alignItems: 'center', justifyContent: 'center', marginLeft: 4 },
});